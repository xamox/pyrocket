...
#		video_dimensions = [176, 144]
		video_dimensions = [320, 240]
			...
			cv.SetCaptureProperty(self.capture, cv._CAP_PROP_FRAME_WIDTH, video_dimensions[0])
			cv.SetCaptureProperty(self.capture, cv._CAP_PROP_FRAME_HEIGHT, video_dimensions[1])
